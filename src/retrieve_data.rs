...
/// Extract the host portion of a URL for reporting attempted API servers.
...
pub fn fetch_data_from_overpass(
...

    {
        ...
        // 2) If the probe does not succeed, run the normal path: the primary servers,
        ...
        if data.is_empty() {
            ...
            // aborts; the latter is allowed because RWM can generate
