...
fn write_worldmod(
    ...
    let mod_dir = world_dir.join("worldmods").join("rwm_mapgen");
    ...
    writeln!(mc, "name = rwm_mapgen")?;
    writeln!(
        mc,
        "description = RWM world configuration (singlenode mapgen + spawn)"
    )?;
    ...
    writeln!(f, "-- RWM world configuration")?;
    writeln!(
        f,
