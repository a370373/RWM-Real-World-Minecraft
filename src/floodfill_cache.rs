...
/// Evidence bitmap for pedestrian/path infrastructure.
/// Read-only evidence source for Building Intelligence.
pub type PathMaskBitmap = CoordinateBitmap;

/// Evidence bitmap for parking infrastructure.
/// Read-only evidence source for Building Intelligence.
pub type ParkingMaskBitmap = CoordinateBitmap;
